...
public:
	...
	list<std::shared_ptr<tuple<int, int, int, int, int>>> rectCardinalConf;
	list<std::shared_ptr<tuple<int, int, int, int, int>>> rectSemiConf;
	list<std::shared_ptr<tuple<int, int, int, int, int>>> rectNonConf;
	list<std::shared_ptr<tuple<int, int, int, int, int>>> cardinalConf;
	list<std::shared_ptr<tuple<int, int, int, int, int>>> semiConf;
	list<std::shared_ptr<tuple<int, int, int, int, int>>> nonConf;
	list<std::shared_ptr<tuple<int, int, int, int, int>>> unknownConf;
	...
	//ICBSNode();
	//ICBSNode(int agent_id, int numAgents, double g_val, double num_of_collisions, int time_expanded, double sum_min_f_vals);
	//ICBSNode(int agent_id, ICBSNode* parent, double g_val, double num_of_collisions, int time_expanded, double sum_min_f_vals);
	void clear();
	//~ICBSNode();
};
